// resources/js/Pages/Clients/Create.jsx - Formulaire mixte Particulier/Professionnel
...
export default function CreateClient() {
    const [clientType, setClientType] = useState("particulier"); // 'particulier' ou 'professionnel'

    const { data, setData, post, processing, errors } = useForm({
        type: "particulier",
        name: "",
        first_name: "", // Pour particuliers
        last_name: "", // Pour particuliers
        company_name: "", // Pour professionnels
        address: "",
        postal_code: "",
        city: "",
        phone: "",
        email: "",
        contact_person: "", // Pour professionnels
        siret: "", // Pour professionnels
        tva_number: "", // Pour professionnels
        payment_terms: 30, // Délai de paiement par défaut
        notes: "",
    });
    ...
    return (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">
                            Ajouter un particulier ou un professionnel
                        </p>
                    </div>
                    <Link
                        href="/clients"
        ...
        >
            <Head title="Nouveau client - BuildFlow" />
